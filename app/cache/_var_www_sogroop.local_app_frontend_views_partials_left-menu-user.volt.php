    ...
    <div class="sidebar col-md-3 col-sm-5">
        <ul class="list-group margin-bottom-25 sidebar-menu">
            ...
            <li class="list-group-item clearfix  <?php if ($this->router->getRewriteUri() == '/room') { ?>active<?php } ?>">
                <a href="/room" >
                    Мои обьявления (<?php echo $this->length($user->ServiceItem); ?>)
                </a>
            </li>
            <li class="list-group-item clearfix  <?php if ($this->router->getRewriteUri() == '/room/balance') { ?>active<?php } ?>">
                <a href="/room/balance" >
            ...
            <li class="list-group-item clearfix">
                <a href="/room/statistic" >
                    Статистика обьявлений (<?php echo $this->length($user->ServiceItem); ?>)
                </a>
            </li>
        </ul>
