...
--
-- Хост: localhost
-- Время создания: Май 08 2015 г., 20:59
...
CREATE TABLE IF NOT EXISTS `banner` (
  ...
  `is_left` tinyint(1) NOT NULL DEFAULT '1',
  `is_right` tinyint(1) NOT NULL DEFAULT '0',
  `is_through` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `banner` (`id`, `title`, `img_src`, `url`, `sort`, `is_left`, `is_right`, `is_through`, `is_active`) VALUES
(1, 'free shiping', '/img/banners/1.png', '/img/banners/1.png', 3, 0, 1, 0, 1),
(2, 'Banner2', 'http://www.nationalflaguk.com/images/slider/banners.png', 'http://google.com.ua', 1, 1, 0, 0, 1),
(4, 'Banner2', 'http://www.aaaflag.com/Media/Default/Subpage%20Backgrounds/banners.jpg', 'http://google.com.ua', 1, 1, 0, 0, 1),
(5, 'free shiping', '/img/banners/1.png', '/img/banners/1.png', 3, 0, 1, 0, 1);
...
(14, 'maxCountVideo', '1'),
(15, 'phone', '+7 385 45 784 55'),
(16, 'fax', '+7 385 45 784 55'),
(17, 'email', 'info@sogroup.com'),
(18, 'userSkype', 'sogroup.com'),
(19, 'address', 'г. Москва, ул. Гагарина, д. 12'),
(20, 'topMenuEnable', '1');
...
INSERT INTO `footer_links` (`id`, `title`, `url`, `is_active`) VALUES
(1, 'Ссылка на статью №1', NULL, 1),
(2, 'Ссылка на статью №2', NULL, 1),
(3, 'Ссылка на статью №3', NULL, 1),
(4, 'Ссылка на статью №4', NULL, 1),
(5, 'Ссылка на статью №5', NULL, 1),
(6, 'Ссылка на статью №6', NULL, 1),
(7, 'Ссылка на статью №7', NULL, 1),
(8, 'Ссылка на статью №8', NULL, 1);
...
INSERT INTO `messages` (`id`, `user_sender_id`, `user_recipient_id`, `subject`, `text`, `date`, `is_unread`, `is_answered`) VALUES
(2, 3, 1, 'Тема сообщения', 'Текст сообщения', '2015-04-05 18:03:23', 1, 1);
...
(2, 'Новость №2', '<p>dasdasdasd asd asd asd</p>', '<p>asdasdasdasdasd</p>', '2015-05-07 20:25:08', '', ''),
(3, 'Новость №3', '<p>asdasd</p>', '<p>asdasd</p>', '2015-05-07 20:25:17', '', ''),
(4, 'Новая новость', '<p>Новая новость описание полное</p>', '<p>Новая новость описание короткое</p>', '2015-05-08 15:26:04', '', '');
...
INSERT INTO `orders` (`id`, `user_id`, `sum`, `date`) VALUES
(1, 3, 400.75, '2015-05-07 00:00:00'),
(2, 1, 150.5, '2015-05-04 00:00:00'),
(3, 1, 150.5, '2015-05-01 00:00:00');
...
(3, 'Описание платных и бесплатных услуг на сайте', '<div class="table-responsive">\n<h4>Вы можете разместить объявление абсолютно бессплатно, но с некоторыми ограничениями, указаными в данной таблице&nbsp;</h4>\n<table class="table table-bordered">\n<tbody>\n<tr class="active"><th>Услуга</th><th class="alignc">Max. к-во фото</th><th class="alignc">Max. к-во видео</th><th class="alignc">К-во символов в описании</th><th class="alignc">Размещение в блоке ТОП</th><th class="alignc">Дополнительно</th><th class="alignc">Стоимость в руб.</th></tr>\n<tr>\n<td>Бессплатное размещение</td>\n<td class="alignc">4</td>\n<td class="alignc">1</td>\n<td class="alignc">500</td>\n<td class="alignc">-</td>\n<td class="alignc">-</td>\n<td class="alignc">-</td>\n</tr>\n<tr>\n<td>Реместить обьявление как ВИП</td>\n<td class="alignc"><strong>Не ограничено</strong></td>\n<td class="alignc"><strong>Не ограничено</strong></td>\n<td class="alignc"><strong>Не <br />ограничено</strong></td>\n<td class="alignc">Да</td>\n<td class="alignc"><strong>Выделение анкеты</strong></td>\n<td class="alignc">300</td>\n</tr>\n<tr>\n<td>Поднятие анкеты на первое место</td>\n<td class="alignc">-</td>\n<td class="alignc">-</td>\n<td class="alignc">-</td>\n<td class="alignc">-</td>\n<td class="alignc">-</td>\n<td class="alignc">120</td>\n</tr>\n</tbody>\n</table>\n</div>', 'asdasd', '', 1),
(4, 'О нас в подвале', '<p>Предоставить пространство для привлечения дополнительного потока клиентов и дать возможность рекламировать свои услуги.<br />Смогут регистрироваться на сайте, размещать свое объявление (ограниченное кол-во символов), фото(ограниченное кол-во)<br />Платно: смогут добавить без ограничений кол-во символов в описании, больше фото, выгрузка видео.</p>', '', '', 0),
(5, 'Текст рассказывающий коротко о портале', '<p><span>Свадьба за границей &ndash; быстро развивающееся и очень выгодное для работы направление. Каждая страна прекрасна по-своему дарит разнообразие пейзажей и свадебных площадок.</span></p>', '', '', 0);
...
(22, 'hhhh', '/files/e8d4c883d5845a02f3ec232a4084d3b0.jpeg', '1111', '1111', '2015-04-18 17:48:28', 111, '', '', 1, 1, 1, 1, 1),
...
(15, '127.0.0.1', 22, '2015-05-07 20:44:23'),
(16, '127.0.0.1', 22, '2015-05-07 20:45:30'),
(17, '127.0.0.1', 22, '2015-05-07 20:45:38'),
(18, '127.0.0.1', 21, '2015-05-07 20:46:17'),
(19, '127.0.0.1', 22, '2015-05-08 17:16:54'),
(20, '127.0.0.1', 22, '2015-05-08 17:18:30'),
(21, '127.0.0.1', 22, '2015-05-08 17:20:54'),
(22, '127.0.0.1', 22, '2015-05-08 17:26:24');
...
INSERT INTO `top_menu` (`id`, `title`, `url`) VALUES
(1, 'свадьба', 'http://google.com.ua'),
(2, 'рождение малыша', ''),
(3, 'презентации', ''),
(4, 'выпускной бал', ''),
(5, 'юбилей', ''),
...
(1, 'serg.tkachenko@hotmail.com', '$2a$08$xJyhdiuFqrPpnix0bBpf6u89K5Sf4o80M6pSOD8e9Ofvzf.uHFQsK', '', 2, '30667f534bc2302873554b266b0adb2b', 3, 2200, 1, 0, '2013-08-24 17:01:02', 1, 0),
